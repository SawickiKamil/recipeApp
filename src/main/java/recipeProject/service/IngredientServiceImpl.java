...
import recipeProject.command.converts.IngredientCommandToIngredient;
import recipeProject.command.converts.IngredientToIngredientCommand;
...
public class IngredientServiceImpl implements IngredientService {
    ...
    @Override
    public IngredientsCommand findByRecipeIdAndId(Long recipeId, Long ingredientId) {
